...
export class ImageViewOperationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ApiParameterScript.fetchdata("user_profile_images", apiData).subscribe((getprofile_res: any) => {
      this.loading = false
  ...
  approved(image: any) {
    ...
    this.ApiParameterScript.updatedata('user_profile_images', update_Dta).subscribe((res: any) => {
      console.log(res);
      this.blockUI.stop()
      if (res.success) {
  ...
  setProfile_picture(image:any){
    ...
    this.ApiParameterScript.updatedata('user_info', update_Dta).subscribe((res: any) => {
      console.log(res);
      this.blockUI.stop()
      if (res.success) {
