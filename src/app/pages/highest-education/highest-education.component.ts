...
export class HighestEducationComponent implements OnInit {
        ...
        let updateData = {
          data: {
            highest_education_name:
              this.highesteducation.value.highest_education_name,
            ...
            if (res.success) {
              Swal.fire({
                ...
                let update = {
                  ...
                  newdata: this.highesteducation.value.highest_education_name,
                  tablename: 'user_education_occupations',
                  coulemnname: 'user_highest_education',
                };
  ...
  update(data: any) {
    ...
    this.ApiParameter.fetchdata('highest_education', {
      projection: ['*'],
      ...
      if (res.success) {
        ...
        this.editedcast = res['data'][0].highest_education_name;
      }
    });
  }
  deleted(data: any) {
    this.blockUI.start('Deleting...');
    this.ApiParameter.deletedata('highest_education', {
      whereConditions: { id: data },
    }).subscribe((res: any) => {
      this.blockUI.stop();
      if (res.success) {
